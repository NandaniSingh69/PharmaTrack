...
// Allow any wallet to register as Manufacturer
function registerManufacturer(string memory _name, string memory _email) public {
    Types.AccountDetails memory acc = Types.AccountDetails({
        role: Types.AccountRole.Manufacturer,
        accountId: msg.sender,
